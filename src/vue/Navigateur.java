...
public abstract class Navigateur extends Application{ // Application de javafx est en réalité une fenêtre
	...
	protected Navigateur()
	{
		...
		VueMirador.getInstance().activerControles();
		//VueAmis.getInstance().activerControles();		
		//VueNumerique.getInstance().activerControles();
		//VueMessages.getInstance().activerControles();
		//VueNouvelles.getInstance().activerControles();
		//VueMonnaies.getInstance().activerControles();
